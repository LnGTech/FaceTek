...
class AbsentVC: UIViewController ,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource{
    ...
    let names:Array<String> = ["suresh","Bandaru","mounika"]
    ...
    @IBOutlet weak var NoLeavesLbl: UILabel!
     override func viewDidLoad() {
        super.viewDidLoad()
         ...
         Absenttbl.register(UINib(nibName: "AbsenttblCell", bundle: nil), forCellReuseIdentifier: "AbsenttblCell")
         Absenttbl.register(UINib(nibName: "AbsentHeaderCell", bundle: nil), forCellReuseIdentifier: "HeaderCell")
    ...
    func AbsentAPIMethod(){
        ...
        let task = URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            if let responseJSON = responseJSON as? [String: Any] {
             ...
             if let absentShiftDetailsid = responseJSON["absentShiftDetails"] as? NSNull {
             if let absentEmpShiftDetails = responseJSON["absentEmpShiftDetails"] as? NSNull {
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        if mDictAttendanceData.allKeys.count > 0{
            if let temp = mDictAttendanceData.value(forKey: "absentShiftDetails") as? NSArray{
                return temp.count
            }
            return 0
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let AbsenttblCell = tableView.dequeueReusableCell(withIdentifier: "AbsenttblCell", for: indexPath) as! AbsenttblCell
         let arrAbsentEmp =  mDictAttendanceData.value(forKey: "absentEmpShiftDetails") as! NSArray
        let arrShiftDetails =  mDictAttendanceData.value(forKey: "absentShiftDetails") as! NSArray
    ...
    @IBAction func AbsentCancelBtn(_ sender: Any) {
