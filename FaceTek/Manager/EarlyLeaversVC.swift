...
class EarlyLeaversVC: UIViewController,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource {
    ...
    func formattedDateFromString(dateString: String, withFormat format: String) -> String? {
         ...
         func EarlyLeaversAPIMethod(){
			...
			var Endpoint = "/attnd-api-gateway-service/api/customer/employee/setup/getEarlyLeaversDetails"
			let url: NSURL = NSURL(string:"\(StartPoint)\(Endpoint)")!

			
             //let url: NSURL = NSURL(string:"http://122.166.152.106:8080/attnd-api-gateway-service/api/customer/employee/setup/getEarlyLeaversDetails")!
          ...
          if let absentShiftDetailsid = responseJSON["earlyLeaversShiftDetails"] as? NSNull {
         if let absentEmpShiftDetails = responseJSON["earlyLeaversEmpShiftDetails"] as? NSNull {
     ...
     self.EarlyLeaverstbl.isHidden = true
         ...
         func numberOfSections(in tableView: UITableView) -> Int {
             if mDictAttendanceData.allKeys.count > 0{
                 if let temp = mDictAttendanceData.value(forKey: "earlyLeaversShiftDetails") as? NSArray{
                     return temp.count
                 }
                 return 0
             }
         ...
         func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
             let AbsenttblCell = tableView.dequeueReusableCell(withIdentifier: "AbsenttblCell", for: indexPath) as! AbsenttblCell
              let arrAbsentEmp =  mDictAttendanceData.value(forKey: "earlyLeaversEmpShiftDetails") as! NSArray
             let arrShiftDetails =  mDictAttendanceData.value(forKey: "earlyLeaversShiftDetails") as! NSArray
             ...
             if arrFilter.count > 0{
                 ...
                 AbsenttblCell.ShiftLbl.text = dictEmp?.value(forKey: "shiftName") as? String
             }
